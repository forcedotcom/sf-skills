...
3. Update navigation and placeholders (see the `generating-salesforce-ui-bundle-ui` skill)
...
A UI Bundle lives under `uiBundles/<AppName>/` and must contain:
