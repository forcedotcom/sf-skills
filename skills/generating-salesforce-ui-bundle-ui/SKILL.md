---
name: generating-salesforce-ui-bundle-ui
...
React apps must not import Salesforce platform modules like `lightning/*` or `@wire` (LWC-only). For data access, use the `using-salesforce-ui-bundle-salesforce-data` skill.
